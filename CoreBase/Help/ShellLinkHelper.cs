...
namespace CoreBase.Help
{
    ...
    /// </summary>
    public class ShellLinkHelper : IDisposable
    {
        //參考至 https://webcache.googleusercontent.com/search?q=cache:s2oYqToWnMkJ:https://dotblogs.com.tw/danking/2013/11/19/130417&hl=zh-TW&gl=tw
        /*
         使用方式： 新增捷徑
        ...
        public ShellLinkHelper() : this(null) { }

        /// <summary>
        /// 初始化後載入捷徑檔案
        /// </summary>
        /// <param name="FullLinkFileName">完整的捷徑檔案名稱</param>
        public ShellLinkHelper(string FullLinkFileName)
        {
            try
            {
